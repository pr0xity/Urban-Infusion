...
public class CartController {
  ...
  public ResponseEntity<?> addOrUpdateProductToCart(@PathVariable long productId, @RequestBody
          Optional<CartItemDto> cartItemDto) {
  ...
  private CartItem getCartItem(long id) {
    return this.cartItemService.getCartItemByShoppingSessionAndProduct(getShoppingSession(),
            getProduct(id));
  }

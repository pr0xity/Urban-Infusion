...
public class CartItemServiceImpl implements CartItemService {
   ...
   */
  @Override
  public CartItem getCartItemByShoppingSessionAndProduct(ShoppingSession shoppingSession,
                                                         Product product) {
    return this.cartItemRepository.findCartItemByShoppingSessionAndProduct(shoppingSession, product)
            .orElse(null);
  }
